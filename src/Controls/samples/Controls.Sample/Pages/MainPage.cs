...
namespace Maui.Controls.Sample.Pages
{
	public class MainPage : BasePage
	{
		...
		void SetupMauiLayout()
		{
			...
			var endTextAlignLabel = new Label { Text = "End-aligned text", BackgroundColor = Color.Fuchsia, HorizontalTextAlignment = TextAlignment.Center };
			endTextAlignLabel.Margin = new Thickness(15, 10, 20, 15);
			verticalStack.Add(endTextAlignLabel);
